...
C.volna = '/home/zyc/zyc/TorchSemiSeg-main/TorchSemiSeg-main/' # the path to the data dir.
...
C.root_dir = '/home/zyc/zyc/TorchSemiSeg-main/TorchSemiSeg-main'
...
C.dataset_path = '/home/zyc/zyc/TorchSemiSeg-main/TorchSemiSeg-main/DATA/Kvasir/'
...
''' Experiments Setting '''
C.labeled_ratio = 2     # ratio of labeled set
...
C.unsup_weight = 0
C.cps_weight = 1.5
config.fm_weight = 1.0

''' Image Config '''
C.num_classes = 2
C.background = 0
C.image_mean = np.array([0.5628792427035936, 0.3277101642192537, 0.24394050461730563])  # 0.485, 0.456, 0.406
C.image_std = np.array([0.3151921905663535, 0.22190745140398543, 0.18981290822216096])
C.image_height = 512
C.image_width = 512
C.num_train_imgs = 1000 // C.labeled_ratio
C.num_eval_imgs = 500
C.num_unsup_imgs = 1000 - C.num_train_imgs     # unsupervised samples
